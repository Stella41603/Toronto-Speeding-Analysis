...
```{r}
#| label: fig-speeding
#| fig-cap: Illustrating the relationship between the count of vehicles observed exceeding 100 km/h and the median speed, measured in kilometers per hour (km/h), for each cardinal direction: Eastbound (EB), Northbound (NB), Southbound (SB), and Westbound (WB).
#| echo: false
#| warning: false
#| message: false
